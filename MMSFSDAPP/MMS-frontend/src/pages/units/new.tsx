...
const UnitSchema = Yup.object().shape({
  ...
  status: Yup.string().oneOf(['Active', 'Deployed', 'StandBy', 'Disbanded']).default('Active'),
});
...
const NewUnitPage = () => {
  ...
  const loadDropdownData = async () => {
    try {
      const [basesData, soldiersData, unitsData] = await Promise.all([
      ...
      setAllUnits(Array.isArray(unitsData) ? unitsData : (unitsData as any).units || []);
    } catch (error) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const newUnit = await unitService.createUnit(submitData);
        addNotification({ type: 'success', title: 'Unit Created', message: `${newUnit.name} has been created successfully.` });
        toast.success('Unit created successfully');
        router.push(`/units/${newUnit._id}`);
      } catch (error: any) {
  ...
  return (
    <>
      <Head><title>Add Unit | MRMS</title></Head>
      <div className="py-6">
            ...
            <div className="form-card-body">
              <form onSubmit={formik.handleSubmit}>
                <div className="form-section">
                  ...
                  <div className="grid grid-cols-1 gap-y-5 gap-x-4 sm:grid-cols-6">
                    <div className="sm:col-span-3 form-group">
                      ...
                      <input type="text" name="name" id="name" className="form-input" placeholder="e.g. 1st Infantry Division"
                    ...
                    <div className="sm:col-span-3 form-group">
                      ...
                      <input type="number" name="capacity" id="capacity" className="form-input" placeholder="100" min="1"
                ...
                <div className="form-section">
                  ...
                  <div className="grid grid-cols-1 gap-y-5 gap-x-4 sm:grid-cols-6">
                    ...
                    <div className="sm:col-span-6 form-group">
                      ...
                      <textarea name="description" id="description" rows={3} className="form-textarea" placeholder="Brief description of the unit..."
                ...
                <div className="form-footer">
                  <Link href="/units" className="btn btn-secondary">Cancel</Link>
